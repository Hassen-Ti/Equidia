const SeancesData = [
    ...
    { id: 10, type: "Technique classique", nom: "Rythme et cadence", discipline: "Dressage", theme: "Rythme", niveau: "G3-4", duree: "20min", intensite: "Légère", objectif: "Stabiliser le rythme aux 3 allures" },
    { id: 11, type: "Technique classique", nom: "Serpentines variées", discipline: "Dressage", theme: "Souplesse", niveau: "G4-5", duree: "30min", intensite: "Moyenne", objectif: "Améliorer la flexibilité sur les courbes" },
    { id: 12, type: "Technique classique", nom: "Travail sur la légèreté", discipline: "Dressage", theme: "Contact", niveau: "G5-6", duree: "30min", intensite: "Moyenne", objectif: "Affiner le contact main-bouche" },
    { id: 13, type: "Technique classique", nom: "Changements de pied au galop", discipline: "Dressage", theme: "Galop", niveau: "G7+", duree: "45min", intensite: "Intense", objectif: "Introduction aux changements de pied (post-Galop 7)" },
    ...
    { id: 43, type: "Technique classique", nom: "Reculer progressif", discipline: "Dressage", theme: "Technique", niveau: "G5-6", duree: "20min", intensite: "Moyenne", objectif: "Maîtriser le reculer droit et fluide" },
    { id: 44, type: "Technique classique", nom: "Appuyer au trot", discipline: "Dressage", theme: "Latéralité", niveau: "G7+", duree: "45min", intensite: "Intense", objectif: "Introduction à l'appuyer (post-Galop 7)" },
    { id: 45, type: "Technique classique", nom: "Variations d'amplitude au trot", discipline: "Dressage", theme: "Impulsion", niveau: "G4-5", duree: "30min", intensite: "Moyenne", objectif: "Allongements et rassemblés au trot" },
    ...
    { id: 30, type: "Technique classique", nom: "Gymnastique à l'obstacle", discipline: "Obstacle", theme: "Gymnastique", niveau: "G6-7", duree: "45min", intensite: "Intense", objectif: "Dispositifs gymniques complexes" },
    { id: 31, type: "Technique classique", nom: "Travail sur la trajectoire", discipline: "Obstacle", theme: "Précision", niveau: "G4-5", duree: "30min", intensite: "Moyenne", objectif: "Améliorer l'abord et la trajectoire" },
    { id: 32, type: "Technique classique", nom: "Détente avant concours CSO", discipline: "Obstacle", theme: "Préparation", niveau: "G5-6", duree: "20min", intensite: "Légère", objectif: "Échauffement type compétition Club 2-3" },
    { id: 33, type: "Technique classique", nom: "Doubles et combinaisons", discipline: "Obstacle", theme: "Technique", niveau: "G5-7", duree: "45min", intensite: "Intense", objectif: "Maîtriser les combinaisons d'obstacles" },
    { id: 34, type: "Technique classique", nom: "Oxers et largeur", discipline: "Obstacle", theme: "Technique", niveau: "G4-5", duree: "30min", intensite: "Moyenne", objectif: "Travailler les obstacles larges" },
    { id: 35, type: "Technique classique", nom: "Parcours chronométré", discipline: "Obstacle", theme: "Vitesse", niveau: "G7+", duree: "45min", intensite: "Intense", objectif: "Optimiser vitesse et technique (Club 1, 100cm+)" },
    { id: 36, type: "Technique classique", nom: "Cavalettis et barres au sol", discipline: "Obstacle", theme: "Préparation", niveau: "G2-3", duree: "20min", intensite: "Légère", objectif: "Travail préparatoire au saut" },
    { id: 55, type: "Technique classique", nom: "Sauts de puces et rebonds", discipline: "Obstacle", theme: "Technique", niveau: "G3-4", duree: "30min", intensite: "Moyenne", objectif: "Travailler les foulées courtes entre obstacles" },
    { id: 56, type: "Technique classique", nom: "Obstacles de couleur", discipline: "Obstacle", theme: "Confiance", niveau: "G3-4", duree: "30min", intensite: "Moyenne", objectif: "Habituer à différents types d'obstacles" },
    { id: 57, type: "Technique classique", nom: "Ligne courbe sur obstacles", discipline: "Obstacle", theme: "Technique", niveau: "G5-6", duree: "45min", intensite: "Intense", objectif: "Enchaînements sur courbes serrées" },
    ...
    { id: 69, type: "Thématique spécifique", nom: "Équilibre horizontal", discipline: "Transversal", theme: "Équilibre", niveau: "G5-6", duree: "30min", intensite: "Moyenne", objectif: "Améliorer la répartition du poids" },
    { id: 70, type: "Thématique spécifique", nom: "Correction de l'asymétrie", discipline: "Transversal", theme: "Rectitude", niveau: "G4-5", duree: "30min", intensite: "Moyenne", objectif: "Rééquilibrer la dissymétrie naturelle" },
    { id: 71, type: "Thématique spécifique", nom: "Mobilité de nuque", discipline: "Transversal", theme: "Souplesse", niveau: "G3-4", duree: "20min", intensite: "Légère", objectif: "Assouplir la nuque et les flexions" },
    { id: 72, type: "Thématique spécifique", nom: "Impulsion naturelle", discipline: "Transversal", theme: "Impulsion", niveau: "G3-4", duree: "30min", intensite: "Moyenne", objectif: "Développer l'énergie volontaire du cheval" },
    { id: 73, type: "Thématique spécifique", nom: "Qualité des transitions", discipline: "Transversal", theme: "Transitions", niveau: "G4-5", duree: "30min", intensite: "Moyenne", objectif: "Affiner la fluidité et la préparation" },
    { id: 74, type: "Thématique spécifique", nom: "Extension d'encolure progressive", discipline: "Transversal", theme: "Décontraction", niveau: "G3-4", duree: "20min", intensite: "Légère", objectif: "Favoriser l'extension en toute sécurité" },
    { id: 75, type: "Thématique spécifique", nom: "Contact et légèreté main-bouche", discipline: "Transversal", theme: "Contact", niveau: "G5-6", duree: "30min", intensite: "Moyenne", objectif: "Affiner la communication par les rênes" },
    { id: 76, type: "Thématique spécifique", nom: "Souplesse longitudinale", discipline: "Transversal", theme: "Souplesse", niveau: "G5-6", duree: "30min", intensite: "Moyenne", objectif: "Allongements et rassemblés fluides" },
    { id: 77, type: "Thématique spécifique", nom: "Activité de l'arrière-main", discipline: "Transversal", theme: "Impulsion", niveau: "G4-5", duree: "30min", intensite: "Moyenne", objectif: "Réveiller et dynamiser les postérieurs" },
    { id: 78, type: "Thématique spécifique", nom: "Préparation physique générale", discipline: "Transversal", theme: "Condition", niveau: "G3-4", duree: "45min", intensite: "Moyenne", objectif: "Séance complète de conditionnement" },
    ...
    { id: 84, type: "Résolution de problème", nom: "Raideur d'un côté", discipline: "Transversal", theme: "Souplesse", niveau: "G3+", duree: "30min", intensite: "Moyenne", objectif: "Assouplir le côté raide" },
    { id: 85, type: "Résolution de problème", nom: "Réactivité aux aides insuffisante", discipline: "Transversal", theme: "Éducation", niveau: "G3+", duree: "30min", intensite: "Moyenne", objectif: "Affiner la réponse aux demandes" },
    { id: 86, type: "Résolution de problème", nom: "Cheval en déséquilibre", discipline: "Transversal", theme: "Équilibre", niveau: "G3+", duree: "30min", intensite: "Moyenne", objectif: "Rétablir l'équilibre horizontal" },
    { id: 87, type: "Résolution de problème", nom: "Cheval qui creuse le dos", discipline: "Transversal", theme: "Posture", niveau: "G3+", duree: "30min", intensite: "Légère", objectif: "Favoriser l'engagement et l'arrondi" },
    { id: 88, type: "Résolution de problème", nom: "Tête en l'air/nuque raide", discipline: "Transversal", theme: "Décontraction", niveau: "G3+", duree: "30min", intensite: "Légère", objectif: "Descendre l'encolure et détendre" },
    { id: 89, type: "Résolution de problème", nom: "Cheval qui coupe les courbes", discipline: "Transversal", theme: "Précision", niveau: "G3+", duree: "30min", intensite: "Moyenne", objectif: "Respecter la trajectoire demandée" },
    { id: 90, type: "Résolution de problème", nom: "Cheval qui ne pousse pas du postérieur", discipline: "Transversal", theme: "Impulsion", niveau: "G3+", duree: "30min", intensite: "Moyenne", objectif: "Activer la propulsion arrière" },
];

export default SeancesData;
